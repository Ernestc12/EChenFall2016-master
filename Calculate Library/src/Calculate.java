...
public class Calculate {
	...
	public static String toImproperFrac(int WholeNumber, int Numerator, int Denominator){
		int ImpNum = WholeNumber*Denominator+Numerator;
		return (ImpNum + "/" + Denominator);
	}
	public static String toMixedNum(int ImproperFrac, int Denominator){
		int numerator = ImproperFrac % Denominator;
		int Wholenumber = ImproperFrac/Denominator;
